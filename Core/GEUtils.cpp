...
//  UTF-8
//
void GE::Core::utf8ToUnicode(const char* pSequence, int* pOutUnicode, int* pOutExtraChars)
{
...
void GE::Core::utf8AppendText(const char* pText, GESTLString* pString, GESTLString* pStringExtension)
{
